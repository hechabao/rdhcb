...
class yijianss_tests(BasePage):
    ...
    wenjianleix_datas = ['定期报告（年报等）','重组报告','基金募集报告','其他再融资报告','评级报告','审计报告','保荐书','法律意见书','固收报告','行研报告','债券发行报告（公司债、企业债、可转债、金融债、PPN等）','其他股/债申报底稿']
    ...
    def wanjianleix_pj_weizhi(self,xuqiu,mokuai1,mokuai2,weizhi):
        n = "//div[@id='scroll']/div[1]/div[1]/div[%s]/div[%s]/div[%s]/div[%s]/div[1]"%(xuqiu,mokuai1,mokuai2,weizhi)
        return n
