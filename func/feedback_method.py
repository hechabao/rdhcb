...
def huoqu(data_fields, data_m):
    list = []
    data_identifier = ['机构名称', '联系人', '联系邮箱', '联系电话', '联系地址', '文件类型', '财务数据范围', '非财务数据范围', '正文内容范围', '其他1', '跨版本对比核查',
                       '本地化部署', '在线充值', '其他2', '时间1', '时间2']
    data_key = ['institution_name', 'person', 'email', 'phone', 'address', 'filetype', 'finance_scope',
                'not_finance_scope', 'text_scope', 'other_scope', 'newNeedOne', 'newNeedTwo', 'newNeedThree',
                'newNeedFour', 'create_time', 'update_time']
